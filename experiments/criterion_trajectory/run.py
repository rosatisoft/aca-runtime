...
from experiments.criterion_trajectory.scenario import TRAJECTORIES
...
def main():
    print("\nExperiment 09 — Criterion Trajectory Diagnostics v0.1\n")
    ...
    for name, steps in TRAJECTORIES.items():
        ...
        for index, text in enumerate(steps, start=1):
            ...
            rational = profile["rational"]
            intentional = profile["intentional"]
            ...
            if previous_profile:
                ...
                print(
                    "Physical:",
                    previous_profile["physical"]["top"],
                    "→",
                    physical["top"],
                )
                print(
                    "Rational:",
                    previous_profile["rational"]["top"],
                    "→",
                    rational["top"],
                )
                print(
                    "Intentional:",
                    previous_profile["intentional"]["top"],
                    "→",
                    intentional["top"],
                )
